...
public class gui implements ActionListener, KeyListener{
	...
	/** This method prompts the gui
	 *  
	 * @call  validateInput, actionPerformed		correct input, get new question
	 */
	public void until_correct(String op, int val1, int val2, int answer, int count, int input) {  
        ...
        if(validateInput(input, answer, count) == 0) {
        	while (validateInput(input, answer, count) == 0) {
        		count++;
        		gui window1 = new gui();
        ...
        //correct input
        if(validateInput(input, answer, count) == 1) {
	...
	/** This method is used to validate the users input
	 *  
	 * @return	0, 1		return value, if input is correct (1) or not (0)
	 */
	private static int validateInput(int input, int answer, int count){
		if(input == answer) {
			return 1;
		}
		return 0;
	}
	/** This method is for the action on the button
	 * 
	 * @call   new_question		calls to get new question
	 */
	...
	/** This method is for when a key is pressed: enter/return, esc
	 * 
	 */
